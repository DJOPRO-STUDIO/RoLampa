export let blocks = {
    ...
    Events:[
    {name:"When a player joins",note:"This works on a Normal Script",id:1,properties:[{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"game.Players.PlayerAdded:Connect(//**function_name**//)"},
    {name:"When a player leaves",note:"This works on a Normal Script",id:1,properties:[{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"game.Players.PlayerRemoving:Connect(//**function_name**//)"},
    {name:"When a Part was Touched",note:"This works on a Normal Script, part to detect field can be for example: game.Workspace.MyPart",id:1,properties:[{name:"Part To Detect",value:"",save_as:"part"},{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"//**part**//.Touched:Connect(//**function_name**//)"},
    {name:"When a Part is Clicked",note:"Detect when a player clicks a part",id:1,properties:[{name:"Part To Detect",value:"",save_as:"part"},{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"//**part**//.ClickDetector.MouseClick:Connect(//**function_name**//)"},
    {name:"When a Player Chats",note:"Trigger an event when a player sends a message in chat",id:1,properties:[{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"game.Players.PlayerChatted:Connect(//**function_name**//)"},
    ...
    {name:"When the Game Starts",note:"Trigger an event when the game starts",id:1,properties:[{name:"Function to fire",value:"",save_as:"function_name"}],string_part2add:"game:BindToClose(//**function_name**//)"}
    ],
    Functions: [
