export let blocks = {
    ...
    { name: "Wait", note: "Pause script execution for a certain amount of time", id: 4, properties: [{ name: "Time (seconds)", value: "", save_as: "time" }], string_part2add: "wait(//**time**//)" },
    ...
    { name: "Check Environment", note: "Detect if the script is running in Studio or Live Game", id: 8, properties: [{ name: "Store in Variable", value: "", save_as: "variable" }], string_part2add: "//**variable**// = game:GetService('RunService'):IsStudio() and 'Studio' or 'Live Game'" }
    ],
    Network: [
